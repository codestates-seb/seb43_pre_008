...
/** 2023/4/19 마이페이지 Profile 전체 컨텐츠 -by 고정윤 */
...
`;
/** 2023/4/19 마이페이지 Profile 왼쪽 컨텐츠 -by 고정윤 */
const LContent = styled.div`
  display: flex;
  flex-direction: column;
  gap: 24px;
`;
/** 2023/4/19 마이페이지 Profile 왼쪽 State컨텐츠 -by 고정윤 */
...
/** 2023/4/19 마이페이지 왼쪽 StatContainer -by 고정윤*/
...
`;
/** 2023/4/19 마이페이지 왼쪽 stats 개별 묶음 -by 고정윤*/
...
/** 2023/4/19 마이페이지 왼쪽 stats의 내용 숫자 -by 고정윤*/
const StatNum = styled.p`
  font-size: 1.6rem;
  padding-bottom: 0.2em;
`;
/** 2023/4/19 마이페이지 왼쪽 stats의 내용 글자 -by 고정윤*/
const StatMsg = styled.p`
  font-size: 1.2em;
  color: #626a73;
`;

/** 2023/4/19 마이페이지 Profile 왼쪽 Communities 묶음-by 고정윤 */
const Communities = styled(Stats)`
  > .edit {
  }
`;
/** 2023/4/19 마이페이지 Profile 왼쪽 Communities 내용 -by 고정윤 */
...
`;
/** 2023/4/19 마이페이지 Profile 왼쪽 Communities 글자 -by 고정윤 */
const CmntMsgTxt = styled(CmntMsg)`
  margin-left: 80px;
  font-size: 1em;
`;
/** 2023/4/19 마이페이지 Profile 왼쪽 Communities 스택오버플로우 로고 -by 고정윤 */
...
/** 2023/4/19 오른쪽 About 컨테이너 묶음 -by 고정윤 */
...
`;
/** 2023/4/19 오른쪽 BadgesContainer 묶음 -by 고정윤 */
const BadgesContainer = styled(AboutContainer)``;

/** 2023/4/19 오른쪽 PostContainer 묶음 -by 고정윤 */
              ...
              {isAbout ? (
                ...
                <>
                  <div className="about-txt">
                    ...
                    <Link className="about-link" to="/badges">
                      badges.
                    </Link>
                  </div>
                </>
